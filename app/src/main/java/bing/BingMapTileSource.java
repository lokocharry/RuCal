...
import bing.ImageryMetaData;
import bing.ImageryMetaDataResource;
...
public class BingMapTileSource extends QuadTreeTileSource implements IStyledTileSource<String> {
     ...
     */
    private static String mBingMapKey = "ApEqyap8rTa4WTNCNv-3pAGQc7XUsHS6595tuDI3MHR59QlahJ5bqYGYhMYJq6Ae";
    ...
    public BingMapTileSource(final String aLocale) {
        super("BingMaps",  ResourceProxy.string.bing, 22, 256, 512, FILENAME_ENDING, null);
        mLocale = aLocale;
        if(mLocale==null) {
    ...
    private ImageryMetaDataResource getMetaData()
    {
        ...
        try {
            ...
            client.setRequestProperty(USER_AGENT, USER_AGENT_VALUE);
            client.connect();
